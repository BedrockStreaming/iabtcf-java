...
import tech.bedrockstreaming.iabtcf.decoder.DecoderOption;
...
public class BitWriterTest {
    ...
    public void testSimpleEncode() {
        ...
        assertThat(tcModel.getSpecialFeatureOptIns(), IntIterableMatcher.matchInts(1));
        assertThat(tcModel.getPurposesConsent(), IntIterableMatcher.matchInts(2, 10));
        assertThat(tcModel.getPurposesLITransparency(), IntIterableMatcher.matchInts(2, 9));
