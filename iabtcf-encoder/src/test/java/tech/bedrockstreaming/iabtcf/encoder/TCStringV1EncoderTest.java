...
public class TCStringV1EncoderTest {
    ...
    public void testCanEncodeV1String() {
        ...
        Assert.assertThat(decodedTCString.getVendorConsent(), IntIterableMatcher.matchInts(1, 2, 8));
        Assert.assertThat(decodedTCString.getPurposesConsent(), IntIterableMatcher.matchInts(1));
