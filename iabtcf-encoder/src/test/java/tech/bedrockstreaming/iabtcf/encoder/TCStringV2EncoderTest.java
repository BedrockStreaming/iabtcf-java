package tech.bedrockstreaming.iabtcf.encoder;

import static tech.bedrockstreaming.iabtcf.encoder.utils.TestUtils.toDeci;
import static tech.bedrockstreaming.iabtcf.test.utils.IntIterableMatcher.matchInts;
...
import tech.bedrockstreaming.iabtcf.decoder.TCString;
import tech.bedrockstreaming.iabtcf.utils.BitSetIntIterable;
import tech.bedrockstreaming.iabtcf.utils.IntIterable;
import tech.bedrockstreaming.iabtcf.v2.PublisherRestriction;
import tech.bedrockstreaming.iabtcf.v2.RestrictionType;
import tech.bedrockstreaming.iabtcf.test.utils.IntIterableMatcher;
...
public class TCStringV2EncoderTest {
    ...
    public void testItConstructsCoreString() {
        ...
        MatcherAssert.assertThat(decoded.getSpecialFeatureOptIns(), IntIterableMatcher.matchInts(1, 2));
        MatcherAssert.assertThat(decoded.getPurposesConsent(), IntIterableMatcher.matchInts(4, 8));
        MatcherAssert.assertThat(decoded.getPurposesLITransparency(), IntIterableMatcher.matchInts(11, 20));
        assertTrue(decoded.getPurposeOneTreatment());
        assertEquals("DE", decoded.getPublisherCC());
        MatcherAssert.assertThat(decoded.getVendorConsent(), IntIterableMatcher.matchInts(1, 4));
        MatcherAssert.assertThat(decoded.getVendorLegitimateInterest(), IntIterableMatcher.matchInts(2, 6));
    }
    ...
    public void testItDecodesAllOptionalSegments() {
        ...
        MatcherAssert.assertThat(decoded.getDisclosedVendors(), IntIterableMatcher.matchInts(1, 2));
        MatcherAssert.assertThat(decoded.getAllowedVendors(), IntIterableMatcher.matchInts(6, 11));
        MatcherAssert.assertThat(decoded.getPubPurposesLITransparency(), IntIterableMatcher.matchInts(2, 3));
        MatcherAssert.assertThat(decoded.getCustomPurposesConsent(), IntIterableMatcher.matchInts(1, 2));
        MatcherAssert.assertThat(decoded.getCustomPurposesLITransparency(), IntIterableMatcher.matchInts(1, 3, 4));
    }
    ...
    public void testPubisherRestrictions() {
        ...
        MatcherAssert.assertThat(pubRest.get(0).getVendorIds(), IntIterableMatcher.matchInts(3, 7));

        assertEquals(1, pubRest.get(1).getPurposeId());
        assertEquals(RestrictionType.NOT_ALLOWED, pubRest.get(1).getRestrictionType());
        MatcherAssert.assertThat(pubRest.get(1).getVendorIds(), IntIterableMatcher.matchInts(3));
    }
    ...
    public void testPubisherRestrictionsAddVendors() {
        ...
        assertEquals(3, pubRest.get(0).getPurposeId());
        assertEquals(RestrictionType.NOT_ALLOWED, pubRest.get(0).getRestrictionType());
        MatcherAssert.assertThat(pubRest.get(0).getVendorIds(), IntIterableMatcher.matchInts(1, 3, 7, 10));

        assertEquals(4, pubRest.get(1).getPurposeId());
        assertEquals(RestrictionType.NOT_ALLOWED, pubRest.get(1).getRestrictionType());
        MatcherAssert.assertThat(pubRest.get(1).getVendorIds(), IntIterableMatcher.matchInts(1, 2, 3, 7, 10));

        assertEquals(5, pubRest.get(2).getPurposeId());
        assertEquals(RestrictionType.NOT_ALLOWED, pubRest.get(2).getRestrictionType());
        MatcherAssert.assertThat(pubRest.get(2).getVendorIds(), IntIterableMatcher.matchInts(1, 2, 3, 7, 10));

        assertEquals(5, pubRest.get(3).getPurposeId());
        assertEquals(RestrictionType.NOT_ALLOWED, pubRest.get(3).getRestrictionType());
        MatcherAssert.assertThat(pubRest.get(3).getVendorIds(), IntIterableMatcher.matchInts(1, 2, 3, 7, 10));

        assertEquals(5, pubRest.get(4).getPurposeId());
        assertEquals(RestrictionType.NOT_ALLOWED, pubRest.get(4).getRestrictionType());
        MatcherAssert.assertThat(pubRest.get(4).getVendorIds(), IntIterableMatcher.matchInts(1, 2, 3, 7, 10));

        assertEquals(5, pubRest.get(5).getPurposeId());
        assertEquals(RestrictionType.NOT_ALLOWED, pubRest.get(5).getRestrictionType());
        MatcherAssert.assertThat(pubRest.get(5).getVendorIds(), IntIterableMatcher.matchInts(1, 2, 3, 7, 10));
    }
    ...
    public void testAddClearPurposesConsent() {
        ...
        MatcherAssert.assertThat(b.toTCString().getPurposesConsent(), IntIterableMatcher.matchInts(4, 8, 10));

        b.clearPurposesConsent();
        b.addPurposesConsent(11);

        MatcherAssert.assertThat(b.toTCString().getPurposesConsent(), IntIterableMatcher.matchInts(11));
    }
    ...
    public void testAddClearVendorConsent() {
        ...
        MatcherAssert.assertThat(b.toTCString().getVendorConsent(), IntIterableMatcher.matchInts(1, 4, 10));

        b.clearVendorConsent();
        b.addVendorConsent(11);

        MatcherAssert.assertThat(b.toTCString().getVendorConsent(), IntIterableMatcher.matchInts(11));
    }
    ...
    public void testAddClearpecialFeatureOptIns() {
        ...
        MatcherAssert.assertThat(b.toTCString().getSpecialFeatureOptIns(), IntIterableMatcher.matchInts(1, 2, 10));

        b.clearSpecialFeatureOptIns();
        b.addSpecialFeatureOptIns(11);

        MatcherAssert.assertThat(b.toTCString().getSpecialFeatureOptIns(), IntIterableMatcher.matchInts(11));
    }
    ...
    public void testAddClearPurposesLITransparency() {
        ...
        MatcherAssert.assertThat(b.toTCString().getPurposesLITransparency(), IntIterableMatcher.matchInts(10, 11, 20));

        b.clearPurposesLITransparency();
        b.addPurposesLITransparency(11);

        MatcherAssert.assertThat(b.toTCString().getPurposesLITransparency(), IntIterableMatcher.matchInts(11));
    }
    ...
    public void testAddClearVendorLegitimateInterest() {
        ...
        MatcherAssert.assertThat(b.toTCString().getVendorLegitimateInterest(), IntIterableMatcher.matchInts(2, 6, 10));

        b.clearVendorLegitimateInterest();
        b.addVendorLegitimateInterest(11);

        MatcherAssert.assertThat(b.toTCString().getVendorLegitimateInterest(), IntIterableMatcher.matchInts(11));
    }
    ...
    public void testAddClearDisclosedVendors() {
        ...
        MatcherAssert.assertThat(b.toTCString().getDisclosedVendors(), IntIterableMatcher.matchInts(7, 9, 10));

        b.clearDisclosedVendors();
        b.addDisclosedVendors(11);

        MatcherAssert.assertThat(b.toTCString().getDisclosedVendors(), IntIterableMatcher.matchInts(11));
    }
    ...
    public void testAddClearPubPurposesConsent() {
        ...
        MatcherAssert.assertThat(b.toTCString().getPubPurposesConsent(), IntIterableMatcher.matchInts(24, 1, 23));

        b.clearPubPurposesConsent();
        b.addPubPurposesConsent(11);

        MatcherAssert.assertThat(b.toTCString().getPubPurposesConsent(), IntIterableMatcher.matchInts(11));
    }
    ...
    public void testAddClearCustomPurposesConsent() {
        ...
        MatcherAssert.assertThat(b.toTCString().getCustomPurposesConsent(), IntIterableMatcher.matchInts(50, 20, 10));

        b.clearCustomPurposesConsent();
        b.addCustomPurposesConsent(11);

        MatcherAssert.assertThat(b.toTCString().getCustomPurposesConsent(), IntIterableMatcher.matchInts(11));
    }
    ...
    public void testAddClearCustomPurposesLITransparency() {
        ...
        MatcherAssert.assertThat(b.toTCString().getCustomPurposesLITransparency(), IntIterableMatcher.matchInts(50, 20, 10));

        b.clearCustomPurposesLITransparency();
        b.addCustomPurposesLITransparency(11);

        MatcherAssert.assertThat(b.toTCString().getCustomPurposesLITransparency(), IntIterableMatcher.matchInts(11));
    }
    ...
    public void testAddClearPubPurposesLITransparency() {
        ...
        MatcherAssert.assertThat(b.toTCString().getPubPurposesLITransparency(), IntIterableMatcher.matchInts(24, 1, 23));

        b.clearPubPurposesLITransparency();
        b.addPubPurposesLITransparency(11);

        MatcherAssert.assertThat(b.toTCString().getPubPurposesLITransparency(), IntIterableMatcher.matchInts(11));
    }
    ...
    public void testAddClearAllowedVendors() {
        ...
        MatcherAssert.assertThat(b.toTCString().getAllowedVendors(), IntIterableMatcher.matchInts(24, 1, 23));

        b.clearAllowedVendors();
        b.addAllowedVendors(11);

        MatcherAssert.assertThat(b.toTCString().getAllowedVendors(), IntIterableMatcher.matchInts(11));
    }
