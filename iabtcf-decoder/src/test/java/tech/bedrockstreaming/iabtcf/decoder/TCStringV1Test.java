...
public class TCStringV1Test {
    ...
    public void testAllowedPurposes() {
        ...
        assertThat(model.getPurposesConsent(), IntIterableMatcher.matchInts(1, 2, 3, 4, 5, 15, 24));
    ...
    public void testBitFieldEncoding() {
        ...
        assertThat(model.getVendorConsent(), IntIterableMatcher.matchInts(1, 25, 30));
    ...
    public void testRangeEncodingDefaultFalse() {
        ...
        assertThat(model.getVendorConsent(), IntIterableMatcher.matchInts(expectedVendorIds));
