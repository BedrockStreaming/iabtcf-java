...
class TCStringV1 implements TCString {
    ...
    public int getVersion() {
        return bbv.readBits6(FieldDefs.V1_VERSION);
    }

    @Override
    public Instant getCreated() {
        return Instant.ofEpochMilli(bbv.readBits36(FieldDefs.V1_CREATED) * 100);
    }

    @Override
    public Instant getLastUpdated() {
        return Instant.ofEpochMilli(bbv.readBits36(FieldDefs.V1_LAST_UPDATED) * 100);
    }

    @Override
    public int getCmpId() {
        return bbv.readBits12(FieldDefs.V1_CMP_ID);
    }

    @Override
    public int getCmpVersion() {
        return bbv.readBits12(FieldDefs.V1_CMP_VERSION);
    }

    @Override
    public int getConsentScreen() {
        return bbv.readBits6(FieldDefs.V1_CONSENT_SCREEN);
    }

    @Override
    public String getConsentLanguage() {
        return bbv.readStr2(FieldDefs.V1_CONSENT_LANGUAGE);
    }

    @Override
    public int getVendorListVersion() {
        return bbv.readBits12(FieldDefs.V1_VENDOR_LIST_VERSION);
    }

    @Override
    public IntIterable getVendorConsent() {
        return fillVendorsV1(bbv, FieldDefs.V1_VENDOR_MAX_VENDOR_ID, FieldDefs.V1_VENDOR_BITRANGE_FIELD);
    }
    ...
    public IntIterable getPurposesConsent() {
        return TCStringV2.fillBitSet(bbv, FieldDefs.V1_PURPOSES_ALLOW);
    }
