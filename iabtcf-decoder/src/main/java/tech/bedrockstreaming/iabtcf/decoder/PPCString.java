...
import tech.bedrockstreaming.iabtcf.decoder.base64.Base64DecoderProvider;
import tech.bedrockstreaming.iabtcf.exceptions.ByteParseException;
import tech.bedrockstreaming.iabtcf.exceptions.UnsupportedVersionException;
...
public class PPCString {
    ...
    public static PPCString decode(String consentString)
        ...
        byte[] bytes = Base64DecoderProvider.decoder.decode(consentString);
